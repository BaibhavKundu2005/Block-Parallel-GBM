...
def run_all(santander_path, n_estimators=400, precomputed=None):
    ...
    preflight_profiler(X_tr, y_tr, max_features=0.5, max_depth=4, min_samples_leaf=20, label="Santander experiments")
    ...
    try:
        ...
        preflight_profiler(X_tr2, y_tr2, max_features=0.5, max_depth=4, min_samples_leaf=20, label="UCI Adult experiments")
